...
# $ snmpwalk -v2c -c passprojet 192.168.176.2 sysLocation.0 sysDescr.0
# $ snmpwalk -v3 -l authPriv -u user1 -a SHA -A miracle2022 -x AES -X power2022 192.168.140.140 sysLocation.0 sysDescr.0
